...
| **★ 本研究（Double DQN）** | — | Double DQN + Experience Replay + Target Network | 等待時間 ↓ **70.4%**（實測）/ 佇列 ↓ **56%** | 黃燈損耗 tradeoff |
...
> **結合 Double DQN 學習能力與 SUMO 模擬真實性，突破靜態規則極限，實現全局動態最佳化。**
> **實測結果：等待時間改善 70.4%（8.6s → 2.5s），佇列縮短 56%。**
