...
| 指標 | 初期 (Ep.1) | 後期 (Ep.200) | 改善幅度 |
|------|------------|--------------|---------|
| Episode Reward | -8×10⁶ | -2×10⁶ | ↑ 75% |
| 總等待時間 | 8×10⁶ s | 2×10⁶ s | ↓ 75% |
| Training Loss | 6×10⁷ | 1×10⁶ | ↓ 98% |

> Reward 從 -8×10⁶ 逐漸收斂至 -2×10⁶，等待時間顯著下降，Loss 穩定收斂，代表 DQN 成功學習到有效的號誌控制策略。
...
|------|-------------|------------------|---------|
| ⏱️ 平均等待時間 | **3.6 秒/台** | 5.0 秒/台 | **↓ 27.3%** ✅ |
| 🚗 平均吞吐量 | 2086 台 | 2410 台 | -13.4% |

> DQN 在平均等待時間指標上優於傳統定時號誌 **27.3%**，顯示 AI 能有效識別壅塞方向並優先放行。吞吐量方面較 Fixed-Time 低 13.4%，主因為安全約束（最小綠燈 10 秒）使切換頻率較為保守，為未來可調優的方向。
